...
public final class PropertyModelBuilder<T> {
    ...
    public PropertyModelBuilder<T> readAnnotations(List<Annotation> annotations2) {
        this.readAnnotations = Collections.unmodifiableList(Assertions.notNull("annotations", annotations2));
        return this;
    }
