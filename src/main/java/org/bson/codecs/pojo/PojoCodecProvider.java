...
implements CodecProvider {
    ...
    private PojoCodecProvider(boolean automatic, Map<Class<?>, ClassModel<?>> classModels, Set<String> packages2, List<Convention> conventions, List<PropertyCodecProvider> propertyCodecProviders) {
        this.automatic = automatic;
        this.classModels = classModels;
        this.packages = packages2;
        this.conventions = conventions;
        this.discriminatorLookup = new DiscriminatorLookup(classModels, packages2);
    ...
    public static final class Builder {
        ...
        public Builder register(Class<?> ... classes2) {
            this.clazzes.addAll(Arrays.asList(classes2));
            return this;
        }
