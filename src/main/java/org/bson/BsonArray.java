...
Cloneable {
    ...
    public BsonArray(List<? extends BsonValue> values2) {
        this(values2, true);
    }
    ...
    BsonArray(List<? extends BsonValue> values2, boolean copy2) {
        this.values = copy2 ? new ArrayList<BsonValue>(values2) : values2;
    }
