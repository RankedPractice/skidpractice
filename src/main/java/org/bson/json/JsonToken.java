...
class JsonToken {
    ...
    JsonToken(JsonTokenType type2, Object value) {
        this.value = value;
        this.type = type2;
    }
    ...
    public <T> T getValue(Class<T> clazz) {
        try {
            ...
            throw new JsonParseException(String.format("Exception converting value '%s' to type %s", this.value, clazz.getName()), new Object[]{e});
        }
    }
