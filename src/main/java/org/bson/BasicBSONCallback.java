...
implements BSONCallback {
    ...
    @Override
    @Deprecated
    public void gotBinaryArray(String name, byte[] data2) {
        this.gotBinary(name, (byte)0, data2);
    }

    @Override
    public void gotBinary(String name, byte type2, byte[] data2) {
        if (type2 == 0 || type2 == 2) {
            this._put(name, data2);
        } else {
            this._put(name, new Binary(type2, data2));
        }
    }
    ...
    @Override
    public void gotCodeWScope(String name, String code, Object scope2) {
        this._put(name, new CodeWScope(code, (BSONObject)scope2));
    }
