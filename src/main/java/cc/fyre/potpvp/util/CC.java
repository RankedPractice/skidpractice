...
public class CC {
    public static final String PRIMARY = CC.translate("&B");
    public static final String B_PRIMARY = CC.translate("&B");
    public static final String SECONDARY = CC.translate("&f");
    public static final String BLUE = ChatColor.BLUE.toString();
    public static final String AQUA = ChatColor.AQUA.toString();
    public static final String YELLOW = ChatColor.YELLOW.toString();
    public static final String RED = ChatColor.RED.toString();
    public static final String GRAY = ChatColor.GRAY.toString();
    public static final String GOLD = ChatColor.LIGHT_PURPLE.toString();
    ...
    public static String translate(String in) {
        return ChatColor.translateAlternateColorCodes((char)'&', (String)in);
    }

    public static List<String> translate(List<String> lines) {
        ArrayList<String> toReturn = new ArrayList<String>();
        for (String line : lines) {
            toReturn.add(ChatColor.translateAlternateColorCodes((char)'&', (String)line));
        }
        return toReturn;
    }
