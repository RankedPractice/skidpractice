...
extends ItemListener {
    ...
    private Function<KitType, CustomSelectKitTypeMenu.CustomKitTypeMeta> selectionMenuAddition(QueueType queueType) {
        return kitType -> {
            ...
            return new CustomSelectKitTypeMenu.CustomKitTypeMeta(Math.max(1, Math.min(64, queueType.isRanked() ? inQueueRanked + inFightsRanked : (queueType.isPremium() ? inQueuePremium + inFightsPremium : inQueueUnranked + inFightsUnranked))), (List<String>)(queueType.isRanked() ? ImmutableList.of((Object)(net.md_5.bungee.api.ChatColor.WHITE + " "), (Object)(net.md_5.bungee.api.ChatColor.AQUA + "" + ChatColor.BOLD + net.md_5.bungee.api.ChatColor.UNDERLINE + "Ranked:"), (Object)(net.md_5.bungee.api.ChatColor.GREEN + "  In fights: " + net.md_5.bungee.api.ChatColor.WHITE + inFightsRanked), (Object)(net.md_5.bungee.api.ChatColor.GREEN + "  In queue: " + net.md_5.bungee.api.ChatColor.WHITE + inQueueRanked), (Object)(net.md_5.bungee.api.ChatColor.WHITE + " "), (Object)(net.md_5.bungee.api.ChatColor.AQUA + "" + ChatColor.BOLD + "Unranked:"), (Object)(net.md_5.bungee.api.ChatColor.GREEN + "  In fights: " + net.md_5.bungee.api.ChatColor.WHITE + inFightsUnranked), (Object)(net.md_5.bungee.api.ChatColor.GREEN + "  In queue: " + net.md_5.bungee.api.ChatColor.WHITE + inQueueUnranked)) : (queueType.isPremium() ? ImmutableList.of((Object)(net.md_5.bungee.api.ChatColor.WHITE + " "), (Object)(net.md_5.bungee.api.ChatColor.RED + "" + ChatColor.BOLD + "Premium:"), (Object)(net.md_5.bungee.api.ChatColor.GREEN + "  In fights: " + net.md_5.bungee.api.ChatColor.WHITE + inFightsPremium), (Object)(net.md_5.bungee.api.ChatColor.GREEN + "  In queue: " + net.md_5.bungee.api.ChatColor.WHITE + inQueuePremium)) : ImmutableList.of((Object)(net.md_5.bungee.api.ChatColor.WHITE + " "), (Object)(net.md_5.bungee.api.ChatColor.AQUA + "" + ChatColor.BOLD + "Ranked:"), (Object)(net.md_5.bungee.api.ChatColor.GREEN + "  In fights: " + net.md_5.bungee.api.ChatColor.WHITE + inFightsRanked), (Object)(net.md_5.bungee.api.ChatColor.GREEN + "  In queue: " + net.md_5.bungee.api.ChatColor.WHITE + inQueueRanked), (Object)(net.md_5.bungee.api.ChatColor.AQUA + " "), (Object)(net.md_5.bungee.api.ChatColor.AQUA + "" + ChatColor.BOLD + net.md_5.bungee.api.ChatColor.UNDERLINE + "Unranked:"), (Object)(net.md_5.bungee.api.ChatColor.GREEN + "  In fights: " + net.md_5.bungee.api.ChatColor.WHITE + inFightsUnranked), (Object)(net.md_5.bungee.api.ChatColor.GREEN + "  In queue: " + net.md_5.bungee.api.ChatColor.WHITE + inQueueUnranked)))));
        };
    }
}
